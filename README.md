...
- If the user selects the admin login option they are taken to a page with a form to login. Information the user provides:
        - admin username
        - admin password
- If the user successfully logs in, the following should content should then be displayed on the admin page
...
### Scrum Team 6 | Project: Stock Data Visualizer App

- Sebastian Main, Mia Altamirano, Trent Duffey, Ben Cummings
- INFOTC, University of Columbia-Missouri
